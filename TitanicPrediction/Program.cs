    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var pipeline = mlContext.Transforms.DropColumns("Name", "Cabin", "Ticket")
                ...
                // step 3: convert string ageås to floats
            ...
            var predictionEngine = mlContext.Model.CreatePredictionEngine<PaxTrip, PaxTripFarePrediction>(trainedModel);

            // create a sample record
            var passenger = new PaxTrip()
            {
                Pclass = 1,
                Name = "Eduard Snowden",
                Sex = "male",
